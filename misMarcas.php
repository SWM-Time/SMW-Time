    ...
    <body>
        ...
        <div class="container">
            <table class="table table-striped">
                ...
                <tbody>
                    <?php
                    $resultado = $conexion->query("SELECT * FROM tiempos INNER JOIN pruebas ON tiempos.idPrueba = pruebas.idPrueba WHERE idUsuario = ".$foo." AND idTipoPiscina = 1 OR idTipoPiscina = 2  ORDER BY pruebas.idPrueba ASC");
